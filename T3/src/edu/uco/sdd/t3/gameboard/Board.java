 ...
 * uses a strategy to determine how markers are placed on the board, but
 * otherwise is not directly responsible for placing markers on the board,
 * despite its member function.
 * 
 * @author Joshua Ford
 * @version 1.0
 */
public class Board {
	 ...
	 * 
	 * @param boardSize	The size of the board as a single number, e.g. "3" = 3 x 3 game board.
	 */
	 ...
	 * 
	 * @param action The action that contains the coordinates and PlayerId.
	 ...
	 * 
	 * @param s The MarkerPlacementStrategy that determines how markers
	 * 			are placed.
	 */
	...
	/**
	 * 
	 * @return True if the total number of markers placed equals
	 * 		   the amount of available spaces available on the board.
	 * 		   False otherwise.
	 */
	...
	/**
	 * Attaches a BoardObserver to this Board. Such an
	 * observer will be notified when a marker is successfully
	 * placed on the board.
	 * 
	 * @param observer The BoardObserver that will observe this board.
	 */
	...
	/**
	 * Removes an observer from this Board. That observer
	 * will no longer be notified of any markers that are placed.
	 * 
	 * @param observer The BoardObserver that will no longer observe this board.
	 */
